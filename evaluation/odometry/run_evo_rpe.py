#!/usr/bin/env python3
"""Run evo_rpe with a benchmark-friendly CLI."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare an evo_rpe command.")
    ...
    parser.add_argument(
        ...
        default="sim3",
        help="Alignment mode to use when invoking evo_rpe",
    )
...
def main() -> int:
    args = parse_args()
    cmd = ["evo_rpe", "tum", str(args.ref), str(args.est)]
