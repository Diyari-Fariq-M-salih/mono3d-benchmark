...
| ORB-SLAM3 | method | `UZ-SLAMLab/ORB_SLAM3` | Docker first, host build second | pending | supports EuRoC mono and mono-inertial |
| DSO | method | `JakobEngel/dso` | Docker first, host build second | pending | legacy dependency stack |
| SVO Pro Open | method | `uzh-rpg/rpg_svo_pro_open` | Docker or ROS workspace | pending | replace older open SVO clone to keep the workspace clean |
